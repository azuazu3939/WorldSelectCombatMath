    ...
    public void onDamaged(EntityDamageByEntityEvent event) {
        ...
        for (String worldName : WorldSelectCombatMath.inst().getConfig().getStringList("WorldName")) {
            if (damaged.getWorld().getName().equals(worldName)) {
                ...
                double finalDamageMath = (damage / (1 + (armor * 0.05))) - toughness;
                if (finalDamageMath <= 0) {
                    ...
                    if (damaged.getEquipment() != null) {
                        ...
                        if (damaged.getEquipment().getBoots() != null && event.getCause().equals(EntityDamageEvent.DamageCause.PROJECTILE) &&
                        ...
                        if (damaged.getEquipment().getBoots() != null && event.getCause().equals(EntityDamageEvent.DamageCause.ENTITY_EXPLOSION) &&
                        ...
                        if (damaged.getEquipment().getLeggings() != null && event.getCause().equals(EntityDamageEvent.DamageCause.PROJECTILE) &&
                        ...
                        if (damaged.getEquipment().getLeggings() != null && event.getCause().equals(EntityDamageEvent.DamageCause.ENTITY_EXPLOSION) &&
                        ...
                        if (damaged.getEquipment().getChestplate() != null && event.getCause().equals(EntityDamageEvent.DamageCause.PROJECTILE) &&
                        ...
                        if (damaged.getEquipment().getChestplate() != null && event.getCause().equals(EntityDamageEvent.DamageCause.ENTITY_EXPLOSION) &&
                        ...
                        if (damaged.getEquipment().getHelmet() != null && event.getCause().equals(EntityDamageEvent.DamageCause.PROJECTILE) &&
                        ...
                        if (damaged.getEquipment().getHelmet() != null && event.getCause().equals(EntityDamageEvent.DamageCause.ENTITY_EXPLOSION) &&
                        ...
                        if (level != 0) {
                            finalDamageMath = finalDamageMath * (1 - level * 0.04);
                        }
                    }
                    event.setDamage(0.0);
